          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 text-white">
              ...
              <div className="mt-4">
                <Link
                  href="/programs"
                  className="btn btn-light me-3 fw-semibold"
                >
                  Explore Programs
                </Link>
                <Link
        ...
        <div className="container text-center">
          ...
          <div className="row g-4 mt-4">
            <div className="col-md-4">
              ...
              <p>Celebrating our students’ achievements in innovative projects.</p>
